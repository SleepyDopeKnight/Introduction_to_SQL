...
2. [Chapter II](#chapter-ii) \
    2.0. [Exercise 00 - Let’s create separated views for persons](#exercise-00---lets-create-separated-views-for-persons)  
    2.1. [Exercise 01 - From parts to common view](#exercise-01---from-parts-to-common-view)  
    2.2. [Exercise 02 - “Store” generated dates in one place](#exercise-02---store-generated-dates-in-one-place)  
    2.3. [Exercise 03 - Find missing visit days with Database View](#exercise-03---find-missing-visit-days-with-database-view)  
    2.4. [Exercise 04 - Let’s find something from Set Theory](#exercise-04---lets-find-something-from-set-theory)  
    2.5. [Exercise 05 - Let’s calculate a discount price for each person](#exercise-05---lets-calculate-a-discount-price-for-each-person)  
    2.6. [Exercise 06 - Materialization from virtualization](#exercise-06---materialization-from-virtualization)  
    2.7. [Exercise 07 - Refresh our state](#exercise-07---refresh-our-state)  
    2.8. [Exercise 08 - Just clear our database](#exercise-08---just-clear-our-database)  

...
2. [Chapter II](#chapter-ii) \
    2.0. [Exercise 00 - Let’s create indexes for every foreign key](#exercise-00---lets-create-indexes-for-every-foreign-key)  
    2.1. [Exercise 01 - How to see that index works?](#exercise-01---how-to-see-that-index-works)  
    2.2. [Exercise 02 - Formula is in the index. Is it Ok?](#exercise-02---formula-is-in-the-index-is-it-ok)  
    2.3. [Exercise 03 - Multicolumn index for our goals](#exercise-03---multicolumn-index-for-our-goals)  
    2.4. [Exercise 04 - Uniqueness for data](#exercise-04---uniqueness-for-data)  
    2.5. [Exercise 05 - Partial uniqueness for data](#exercise-05---partial-uniqueness-for-data)  
    2.6. [Exercise 06 - Let’s make performance improvement](#exercise-06---lets-make-performance-improvement)  

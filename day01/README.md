...
2. [Chapter II](#chapter-ii) \
    2.0 [Exercise 00 - Let’s make UNION dance](#exercise-00---lets-make-union-dance)\
    2.1 [Exercise 01 - UNION dance with subquery](#exercise-01---union-dance-with-subquery)\
    2.2 [Exercise 02 - Duplicates or not duplicates](#exercise-02---duplicates-or-not-duplicates)\
    2.3 [Exercise 03 - “Hidden” Insights](#exercise-03---hidden-insights)\
    2.4 [Exercise 04 - Difference? Yep, let's find the difference between multisets](#exercise-04---difference-yep-lets-find-the-difference-between-multisets)\
    2.5 [Exercise 05 - Did you hear about Cartesian Product?](#exercise-05---did-you-hear-about-cartesian-product)\
    2.6 [Exercise 06 - Lets see on “Hidden” Insights](#exercise-06---lets-see-on-hidden-insights)\
    2.7 [Exercise 07 - Just make a JOIN](#exercise-07---just-make-a-join)\
    2.8 [Exercise 08 - Migrate JOIN to NATURAL JOIN](#exercise-08---migrate-join-to-natural-join)\
    2.9 [Exercise 09 - IN versus EXISTS](#exercise-09---in-versus-exists)\
    2.10 [Exercise 10 - Global JOIN](#exercise-10---global-join)

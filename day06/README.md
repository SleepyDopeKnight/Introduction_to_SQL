...
2. [Chapter II](#chapter-ii) \
    2.0. [Exercise 00 - Discounts, discounts , everyone loves discounts](#exercise-00---discounts-discounts-everyone-loves-discounts)  
    2.1. [Exercise 01 - Let’s set personal discounts](#exercise-01---lets-set-personal-discounts)  
    2.2. [Exercise 02 - Let’s recalculate a history of orders.](#exercise-02---lets-recalculate-a-history-of-orders)  
    2.3. [Exercise 03 - Improvements are in a way](#exercise-03---improvements-are-in-a-way)  
    2.4. [Exercise 04 - We need more Data Consistency](#exercise-04---we-need-more-data-consistency)  
    2.5. [Exercise 05 - Data Governance Rules](#exercise-05---data-governance-rules)  
    2.6. [Exercise 06 - Let’s automate Primary Key generation](#exercise-06---lets-automate-primary-key-generation)
